function onCreate()
	-- background shit
	makeAnimatedLuaSprite('Bg','Bg',-600, -300)addAnimationByPrefix('Bg', 'idle','Bg',20,true)
	...
	makeAnimatedLuaSprite('Floor','Floor',-650, -200)addAnimationByPrefix('Floor', 'idle','Floor',24,true)
